...
/*--------------- FINE IMPOSTAZIONI SEO----------------------*/
	...
	if ( defined('WPSEO_VERSION') ) {
				...
				/* microformat */
				add_filter( 'wpseo_head', function() use ($payloadresource) { bfi_add_json_ld( $payloadresource ); } , 10, 1 );
				add_filter( 'wpseo_head',function() use ($payload) { bfi_add_json_ld($payload);} , 10, 1 );
...
?>
<bfi-page class="bfi-page-container bfi-experience-page ">
	<div class="bfi_page_container">
		<div class="bookingforwidget" path="experience" 
