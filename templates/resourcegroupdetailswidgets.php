...
/*---------------IMPOSTAZIONI SEO----------------------*/
	...
	if ( defined('WPSEO_VERSION') ) {
		...
		if (!empty($resource->ImageUrl)){
			add_action( 'wp_head', function() use ($resource) {return bfi_add_opengraph_image("https:".BFCHelper::getImageUrlResized('resources',$resource->ImageUrl, 'resourcegroup')); }, 10, 1);
		}
	}
...
?>
<bfi-page class="bfi-page-container bfi-resourcegroupdetails-page ">
