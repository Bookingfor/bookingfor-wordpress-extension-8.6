<?php
/**
 * Sitemaps: BFI_Sitemaps_Stylesheet class
 *
...
class BFI_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by BookingFor to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
						...
						<table id="sitemap__table">
							...
							<tbody>
								<xsl:for-each select="sitemap:urlset/sitemap:url">
									<tr>
										<td class="loc"><a href="{sitemap:loc}" target="_blank"><xsl:value-of select="sitemap:loc" /></a></td>
										<xsl:if test="\$has-lastmod">
