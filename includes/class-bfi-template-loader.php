...
//		add_filter( 'comments_template', array( __CLASS__, 'comments_template_loader' ) );
	...
	public static function template_loader( $template ) {
		...
		if ( is_page( bfi_get_template_page_id( 'searchpackages' ) )) {
//			$file 	= 'search-packages.php';
			$file 	= 'search-packageswidgets.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		if ( is_page( bfi_get_template_page_id( 'packagesdetails' ) )) {
			$file 	= 'packagesdetailswidgets.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}

		if ( is_page( bfi_get_template_page_id( 'searchavailability' ) )) {
			$file 	= 'search-availabilitywidgets.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
...
//		}
		if ( is_page( bfi_get_template_page_id( 'cartdetails' ) )) {
			$file 	= 'cartdetailswidgets.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
		if ( is_page( bfi_get_template_page_id( 'genericrequest' ) )) {
			$file 	= 'genericrequestwidgets.php';
			$find[] = $file;
			$find[] = BFI()->template_path() . $file;
		}
