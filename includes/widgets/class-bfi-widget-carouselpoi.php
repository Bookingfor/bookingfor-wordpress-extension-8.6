...
if ( ! class_exists( 'BFI_Widget_CarouselPoi' ) ) :
class BFI_Widget_CarouselPoi extends WP_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'bfi-widget_carouselpoi';
		$this->widget_description = __( 'A Carousel list of Poi.', 'bfi' );
		$this->widget_id          = 'bookingfor_carouselpoi';
		$this->widget_name        = __( 'BookingFor Carousel Poi', 'bfi' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
...
function form($instance) {
	...
	$tagsList = BFCHelper::getTags($language,pow(2, 6));
...
<div class="bookingfor_carousel bficarouselpoi"
...
jQuery("#<?php echo $newcodeid ?>").on( 'visibility', function() {
	...
	public function widget( $args, $instance ) {
		...
		bfi_get_template("widgets/carouselpoiwidgets.php",$args);	
	}
