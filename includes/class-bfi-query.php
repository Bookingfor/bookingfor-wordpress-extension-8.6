...
//		}
	...
	public function init_query_vars() {
		...
		$this->query_vars = array(
			...
			'packagesdetails'          => get_option( 'packagesdetails', 'packagesdetails' ),
		);
	}
...
//			}
			...
			if ( 'packagesdetails' == $key ) {
				...
				$page_id   = bfi_get_page_id( 'packagesdetails' ); 
				$page_slug = get_post( $page_id )->post_name;
				// e.g. /page-slug/my-endpoint/123/some-string/
				...
				add_rewrite_rule(
					"^(?:[a-z]{2}/|){$page_slug}/([^/-]*)-([^/]*)(?:/)([^/]*)/page/([^/]*)?$",
					'index.php?page_id=' . $page_id . '&resource_id=$matches[1]&resource_name=$matches[2]&bfi_layout=$matches[3]&currpage=$matches[4]',
					'top'
				);
				add_rewrite_rule(
					"^(?:[a-z]{2}/|){$page_slug}/([^/-]*)-([^/]*)(?:/)([^/]*)?$",
